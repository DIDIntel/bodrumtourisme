        ...
        (function (window) {
            var i, support, Expr, getText, isXML, tokenize, compile, select, outermostContext, sortInput, hasDuplicate, setDocument, document, docElem, documentIsHTML, rbuggyQSA, rbuggyMatches, matches, contains, expando = "sizzle" + 1 * new Date(), preferredDoc = window.document, dirruns = 0, done = 0, classCache = createCache(), tokenCache = createCache(), compilerCache = createCache(), nonnativeSelectorCache = createCache(), sortOrder = function (a, b) {
                ...
                whitespace + "*\\]", pseudos = ":(" + identifier + ")(?:\\((" + "('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|" + "((?:\\\\.|[^\\\\()[\\]]|" + attributes + ")*)|" + ".*" + ")\\)|)", rwhitespace = new RegExp(whitespace + "+", "g"), rtrim = new RegExp("^" + whitespace + "+|((?:^|[^\\\\])(?:\\\\.)*)" +
                    whitespace + "+$", "g"), rcomma = new RegExp("^" + whitespace + "*," + whitespace + "*"), rcombinators = new RegExp("^" + whitespace + "*([>+~]|" + whitespace + ")" + whitespace + "*"), rdescend = new RegExp(whitespace + "|>"), rpseudo = new RegExp(pseudos), ridentifier = new RegExp("^" + identifier + "$"), matchExpr = {
                        "ID": new RegExp("^#(" + identifier + ")"), "CLASS": new RegExp("^\\.(" + identifier + ")"), "TAG": new RegExp("^(" + identifier + "|[*])"), "ATTR": new RegExp("^" + attributes), "PSEUDO": new RegExp("^" + pseudos), "CHILD": new RegExp("^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\(" +
                            ...
                            whitespace + "*(\\d+)|))" + whitespace + "*\\)|)", "i"), "bool": new RegExp("^(?:" + booleans + ")$", "i"), "needsContext": new RegExp("^" + whitespace + "*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\(" + whitespace + "*((?:-\\d)?\\d*)" + whitespace + "*\\)|)(?=[^-]|$)", "i")
...
; var noise = { generator: function (n, e, t) { function a() { r.width = window.innerWidth, r.height = window.innerHeight } function i(n) { for (var t = n.canvas.width, a = n.canvas.height, i = n.createImageData(t, a), r = new Uint32Array(i.data.buffer), o = r.length, d = 0; o > d;)r[d++] = (e * Math.random() | 0) << 24; n.putImageData(i, 0, 0) } var r = document.getElementById(n), o = r.getContext("2d"); a(), window.onresize = a; var d = !0; !function h() { return (d = !d) ? void requestAnimationFrame(h) : (i(o), void (0 == t && requestAnimationFrame(h))) }() } };
//# sourceMappingURL=noise.min.js.map
; (function () {
...
; console.log("%c                                    \n       DEVELOPPED WITH ♥ & ♫        \n    https://twitter.com/bodrumtourisme   \n                                    ", "background: #3B94D9; color: #ffffff"); var SD = SD || {}; SD.main = function ($) { return _app = { intro: function (element) { var getWidth = element.find(".row .deco.front").outerWidth(); element.find(".deco.back").css("width", getWidth + "px") }, initMenu: function () { var getNav = $("body > nav").html(); $("section .menu-container").each(function () { $(this).html("<nav>" + getNav + "</nav>") }), $("body > section").each(function () { var getId = $(this).attr("id"); $(this).find('.menu-container nav ul li[data-section="' + getId + '"]').addClass("active") }) } }, { init: function () { noise.generator("noise", 50, !1), _app.initMenu(), $("#engagements .row > div .content-slider .slider-container > div").first().addClass("visible"), $("#introduction .row article").addClass("animated"), _app.intro($("#introduction")), SmoothScroll({ stepSize: 150, animationTime: 1200, keyboardSupport: !0, arrowScroll: 150 }) } } }(jQuery), jQuery(function ($) { SD.main.init(), $(document).on("click", ".calculator-content .select span", function () { $(".calculator-content .select ul").slideUp(), $(this).parent().hasClass("open") ? ($(this).siblings("ul").slideUp(), $(this).parent().removeClass("open")) : ($(this).siblings("ul").slideDown(), $(this).parent().addClass("open")) }), $(document).on("click", "#engagements .pagination #slider-prev", function () { var getCurrent = parseInt($("#engagements .pagination .current").html()) - 1; 0 < getCurrent && ($(".engagements-slider > div").css("transform", "translateX(calc(-100% * " + (getCurrent - 1) + "))"), $("#engagements .pagination .current").html(("0" + getCurrent).slice(-2))), 1 < getCurrent ? $("#slider-prev").attr("class", "visible") : $("#slider-prev").attr("class", ""), getCurrent > parseInt($("#engagements .pagination .max").html()) - 1 ? $("#slider-next").attr("class", "") : $("#slider-next").attr("class", "visible"), $("#engagements .content-slider .slider-container > div").removeClass("visible"), $("#engagements .content-slider .slider-container > div").eq(getCurrent - 1).addClass("visible") }), $(document).on("click", "#engagements .pagination #slider-next", function () { var getCurrent = parseInt($("#engagements .pagination .current").html()); getCurrent < parseInt($("#engagements .pagination .max").html()) && ($(".engagements-slider > div").css("transform", "translateX(calc(-100% * " + getCurrent + "))"), $("#engagements .pagination .current").html(("0" + (getCurrent + 1)).slice(-2))), 0 < getCurrent ? $("#slider-prev").attr("class", "visible") : $("#slider-prev").attr("class", ""), getCurrent == parseInt($("#engagements .pagination .max").html()) - 1 ? $("#slider-next").attr("class", "") : $("#slider-next").attr("class", "visible"), $("#engagements .content-slider .slider-container > div").removeClass("visible"), $("#engagements .content-slider .slider-container > div").eq(getCurrent).addClass("visible") }), $(document).on("click", "#prestations .listing-cars li", function () { $("#prestations .listing-cars li h3, #prestations .cars img").removeClass("active"), $(this).find("h3").addClass("active"), $("#prestations .cars img." + $(this).data("car")).addClass("active") }), $(document).on("click", "#introduction .row article .cta", function () { return $("html, body").animate({ scrollTop: $("#contact").offset().top }, "slow"), !1 }), $(document).on("click", "#service .row article .cta", function (e) { if ("#contact" == $(this).attr("href")) return e.preventDefault(), $("html, body").animate({ scrollTop: $("#contact").offset().top }, "slow"), !1 }), $(document).on("click", "body > nav ul li", function () { var el = $(this); $("html, body").animate({ scrollTop: $("body > section#" + el.data("section")).offset().top }) }), $(document).on("click", ".scrollto", function () { $(this); $("html, body").animate({ scrollTop: $("body > section#contact").offset().top }) }), $(window).on("scroll", function () { var currentScroll = $(document).scrollTop(); $("body > section").each(function () { var elt = $(this); elt.offset().top - 1 < currentScroll && !elt.hasClass("previous") && (elt.addClass("previous"), $("nav ul li").removeClass("active"), ("contact" != elt.attr("id") ? $('nav ul li[data-section="' + elt.attr("id") + '"]') : $('nav ul li[data-section="prestations"]')).addClass("active")), elt.offset().top + 1 > currentScroll && elt.hasClass("previous") && (elt.removeClass("previous"), $("nav ul li").removeClass("active"), ("contact" != elt.attr("id") ? $('nav ul li[data-section="' + elt.attr("id") + '"]') : $('nav ul li[data-section="prestations"]')).addClass("active")), 0 == currentScroll && ($("#introduction").removeClass("previous"), $("nav ul li").removeClass("active"), $('nav ul li[data-section="introduction"]').addClass("active")) }), 0 < $(".twist").length && $(".twist").each(function () { var el = $(this); el.offset().top - $(window).height() / 1.5 < currentScroll && !el.hasClass("visible") && el.addClass("visible") }) }); var xmark = $("#fa-xmark").html(), whatsapp = $("#fixed-cta-main-button").html(); $(document).on("click", "#fixed-cta-main-button", function () { $(this).hasClass("fa-xmark") ? ($(this).html(whatsapp), $(this).removeClass("fa-xmark")) : ($(this).html(xmark), $(this).addClass("fa-xmark")), $(this).toggleClass("open") }), $(document).on("click", ".whatsapp", function () { console.log("whatsapp"), ga && ga("send", "event", "Goal", "click", "whatsapp") }), $(document).on("click", ".tel", function () { console.log("phone"), ga && ga("send", "event", "Goal", "click", "phone") }), $(document).on("click", ".mailto", function () { console.log("email"), ga && ga("send", "event", "Goal", "click", "email") }) });